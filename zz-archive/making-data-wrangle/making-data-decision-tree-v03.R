...
dat1 <- 
  ...
  select(EIN, type.org, two.digit, broad.category, letter, letter1, letter2, s.further, s.further.tens, us.state, city.type) %>%
  distinct()
...
## Saving -------------------------
write_csv(dat1, "data-wrangle/mission-info-v03.csv")
