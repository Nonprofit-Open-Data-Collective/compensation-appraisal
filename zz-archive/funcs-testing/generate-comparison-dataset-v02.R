generate_comparisons <- function(geo.weighs, r.mission.weights, s.mission.weights, folder.name){
  ...
  source("funcs-testing/distance-metric-v02.R")
  ...
  mission_info <- read_csv("data-wrangle/mission-info-v02.csv")
  ...
  # Make and save plots 
  rmarkdown::render( input='unit-testing/make-comparison-plots-v02.Rmd', 
